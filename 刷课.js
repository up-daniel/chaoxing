// ==UserScript==
// @name         SuperStar超星学习通助手-支持作业、视频、章节测验全自动处理✨全自动收录题库、一键复制题目✨完全免费✨
// @namespace    https://scriptcat.org/zh-CN/script-show-page/1701
// @version      2.2.0
// @description 【🥇操作简单】SuperStar超星学习通助手具有人性化的操作页面，流畅的步骤提示，上手简单好用【🔊功能齐全】支持视频、音频倍速秒过；各种任务自动完成；字体解密；章节测验、课后作业自动答题、自动提交、自动收录答案；支持自动切换任务点、自动登录等【📔丰富题库】题库完全免费，每日更新，精准识别，答案全对【✨功能扩展】开放自定义参数，功能控制更简单🔜🎉官网https://blog.sagehub.cloudns.ch/category/script/
// @author       DANIEL
// @run-at       document-end
// @match        *://*.chaoxing.com/*
// @match        *://*.edu.cn/*
...
(() => {
    ...
    //-----------------------------------------------------------------------------------------------------
    var host = 'https://nav.sagehub.cloudns.ch&',
        ...
        for (let i = 0, l = spans.length; i < l; i++) {
            if (spans[i].innerHTML.indexOf('章节未开放') != -1) {
                if (_l.href.indexOf("ut=s") != -1) {
                    ...
                    spans[i].innerHTML = '此课程为闯关模式，请回到上一章节完成学习已！'
                    return;
                }
                break;
            }
        ...
        <div class="row" style="margin: 10px;">
            <div class="col-md-6 col-md-offset-3">
                <div class="header clearfix">
                    <h3 class="text-muted" style="margin-top: 40px;margin-bottom: 0;float: left;"><a href=https://scriptcat.org/zh-CN/script-show-page/1701>SuperStar超星学习通助手&ensp;</a></h3><div id="onlineNum"></div>
                </div>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div id="result" style="overflow:auto;line-height: 30px;">
                            <div id="log">
                                <span style="color: red">[00:00:00]如果此提示不消失，说明页面出现了错误，请联系到官网反馈</span>
                            </div>
                        </div>
                    </div>
                </div>
...
`;
                    ...
                    try {
                        if (!isCat) {
                            ...
                            logs.addLog(
                                ...
                                'green');
                                logs.addLog('DANIEL提醒你：如果脚本答题功能异常，请 <a href="https://blog.sagehub.cloudns.ch/archives/2/" target="_blank">点击这里</a> 查看更换token方法', 'red');
                        }
        ...
        try {
            ...
            if (jumpType != 2) {
                ...
                logs.addLog('若整个课程刷完后，还存在未刷任务点，可能是因为准确率未达到100%，另一款答题考试脚本（使用时请关闭刷课脚本且最后需要手动提交答案）可以解决此问题<a href="https://scriptcat.org/zh-CN/script-show-page/1711" target="_blank">点击这里</a>', 'purple');
                logs.addLog('DANIEL提醒你：此页无任务，1秒后自动下一章', 'green');
                logs.addLog('DANIEL提醒你：如果脚本答题功能异常，请 <a href="https://blog.sagehub.cloudns.ch/archives/2/" target="_blank">点击这里</a> 查看更换token方法', 'red');
            } else {
        ...
        var video_getReady = (item) => {
            ...
            doVideo = (item) => {
                ...
                if (disableMonitor) {
                    logs.addLog('我有一个个人博客，大家可以去看看，请<a href="https://blog.sagehub.cloudns.ch" target="_blank">点击这里</a>(⁎⁍̴̛͂▿⁍̴̛͂⁎)*✲ﾟ*', '#66CCFF');
                }
                let dtype = 'Video';
...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>SuperStar超星学习通挂机小助手</title>
        <meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" name="viewport">
        <link href="https://z.chaoxing.com/yanshi/css/bootstrap.min.css" rel="stylesheet">
    </head>
    <body>
        <div class="row" style="margin: 10px;">
            <div class="col-md-6 col-md-offset-3">
                <div class="header clearfix">
                    <h3 class="text-muted" style="margin-top: 20px;margin-bottom: 0;float: left;">SuperStar超星学习通挂机小助手&ensp;</h3>
                </div>
                <hr style="margin-top: 10px;margin-bottom: 20px;">
                <div class="panel panel-info">
                    <div class="panel-heading">任务列表</div>
